...
def main():
    ...
    for line in tqdm(sys.stdin):
        try:
            ...
            word_count_document[word_count]     += 1
            number_docs                         += 1
